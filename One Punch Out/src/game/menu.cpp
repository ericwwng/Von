...
Menu::Menu()
{
	...
	AddButton(m_buttons, "Play Game", Vector2f(offsetWidth, SCREEN_HEIGHT / 6), 300, 100);
	AddButton(m_buttons, "Map Editor", Vector2f(offsetWidth, SCREEN_HEIGHT / 3), 300, 100);
	AddButton(m_buttons, "How to Play", Vector2f(offsetWidth, SCREEN_HEIGHT / 2), 300, 100);
	AddButton(m_buttons, "Options", Vector2f(offsetWidth, SCREEN_HEIGHT - (SCREEN_HEIGHT / 3)), 300, 100);
	AddButton(m_buttons, "Exit Game", Vector2f(offsetWidth, SCREEN_HEIGHT - (SCREEN_HEIGHT / 6)), 300, 100);
}
